...
from kernels.mlp_large import large_split_swiglu
...
def _mlp_forward(self, x):
    ...
    elif self.decode_mode and x.shape[0] <= 64:
        product = large_split_swiglu(x, self.gate_proj.weight, self.up_proj.weight)
    else:
