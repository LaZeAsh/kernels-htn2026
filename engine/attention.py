...
from kernels.mlp_b2_4_gemv import b2_4_gemv_swiglu
...
def _mlp_forward(self, x):
    ...
    elif self.decode_mode and 2 <= x.shape[0] <= 4:
        product = b2_4_gemv_swiglu(x, self.gate_proj.weight, self.up_proj.weight)
